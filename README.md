...
**Author:** taki  
**Contact:** Zobayer.Hossain@oulu.fi
**Organization:** University of Oulu
**Website:** https://github.com/Taki1615/testing git repo creation

## Project Overview
predict 3 days flow data
...
```bibtex
@software testing git repo creation,
  author = taki,
  title = testing testing,
  year = 2026,
  version = 0.1.0,
  doi = ,
  url = https://github.com/Taki1615/testing git repo creation
}
```
or
